...
describe("User Controller - createUser", () => {
  it("deve criar usuário com sucesso", async () => {
    ...
    const req = mockReq({ username: "teste", password: "123456" });
    const res = mockRes();
...
describe("User Controller - loginUser", () => {
  ...
  it("deve retornar 401 se usuário não existir", async () => {
    ...
    const req = mockReq({ username: "naoexiste", password: "123456" });
    const res = mockRes();
  ...
  it("deve retornar 401 se senha for inválida", async () => {
    ...
    const req = mockReq({ username: "teste", password: "errada" });
    const res = mockRes();
...
describe("User Controller - changePassword", () => {
  it("deve alterar senha com sucesso", async () => {
    ...
    const req = mockReq({ oldPassword: "123456", newPassword: "654321" }, {}, { id: 1 });
    const res = mockRes();
  ...
  it("deve retornar 401 se senha atual for inválida", async () => {
    ...
    const req = mockReq({ oldPassword: "errada", newPassword: "654321" }, {}, { id: 1 });
    const res = mockRes();
  ...
  it("deve retornar 404 se usuário não existir", async () => {
    ...
    const req = mockReq({ oldPassword: "123456", newPassword: "654321" }, {}, { id: 999 });
    const res = mockRes();
